...
export const vibeCategories = ["All", "Nature", "Dark & Moody", "Urban", "Avengers", "Harry Potter", "Death Note", "Demon Slayer", "Prince of Persia", "Stranger Things", "Game of Thrones"];
...
export const musicCategories = ["For you", "Explore", "Trending", "Saved"];

export const moods = ['Curious', 'Vulnerable', 'Frustrated', 'Hopeful', 'Nostalgic'];
...
export const audiences = ['Everyone', 'Followers', 'Close friends'];
export const exploreRecentItems = [
...
export const exploreTrendingData = [
